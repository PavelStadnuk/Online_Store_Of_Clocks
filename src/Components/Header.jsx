        ...
        <div className={style.WrapperHeader}>
            ...
            <div className={style.WrapNavigation}>
                ...
                <div className={style.mobileMenu}>
                    ...
                    <nav className={mobileMenuOpen ? style.open : ''}>
                        {pages.map((value, index) => {
                            return (
                                <NavLink to={`/${value}`} key={index} onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
                                    {value}
                                </NavLink>
                            );
                        })}
                ...
                <NavLink to='/BuildYourWatch' className={style.designWatch}>
                    <button>Design you watch</button>
                </NavLink>{' '}
                <div className={style.WrapImages}>
                    <img src={User} onClick={toggleUserMenu} />
                    {isUserMenuVisible && (
                        <div className={style.UserMenu}>
                            <NavLink to='/LoginCreateAccount/Login'>
                                <button
                            ...
                            <NavLink to='/LoginCreateAccount/SignUp'>
                                <button
                    ...
                    <img
                        src={Basket}
                        onClick={() => setYourCartVisible(true)}
                    />
                    {isYourCartVisible && (
                        <YourCart
                            date={date}
                            setYourCartVisible={setYourCartVisible}
